...
const textos = {
  pt: {
    ...
    saldoCompras: 'Compras na DEX',
    saldoVendas: 'Vendas na DEX',
    saldoLiquido: 'Saldo',
    ...
    tipoEnvioProjeto: 'Transferência do projeto',
    tipoRecebeProjeto: 'Transferência para o projeto',
    movCompraDex: '{a} comprou tokens na {local}',
    movVendaDex: '{a} vendeu tokens na {local}',
    movTrocaDex: '{a} fez uma troca na {local}; não foi possível saber se comprou ou vendeu',
    movSaque: '{a} sacou tokens da {local} para a própria carteira',
    movDeposito: '{a} depositou tokens na {local}',
    movQueima: '{a} enviou tokens para um endereço de queima (foram destruídos)',
    movEnvioProjeto: 'Carteira do projeto {a} enviou tokens para {b}',
    movRecebeProjeto: '{a} enviou tokens para a carteira do projeto {b}',
    movTransferencia: '{a} enviou tokens para {b}',
    localPoolDesconhecida: 'pool de negociação não identificada',
    raioCorretorasTitulo: 'Corretoras identificadas (não é compra nem venda)',
    raioCorretorasTexto: (saq, nSaq, dep, nDep) => `Saques: ${saq} (${nSaq}) — tokens saindo da corretora para carteiras pessoais. Depósitos: ${dep} (${nDep}) — tokens entrando na corretora, o que costuma vir antes de uma venda lá dentro.`,
    ...
    raioSub: 'As mesmas compras e vendas do balanço (só pools DEX), separadas por tipo de carteira que negociou.',
    raioCategoria: 'Quem',
    raioSaldo: 'Saldo',
  ...
  en: {
    ...
    saldoCompras: 'Bought on DEX',
    saldoVendas: 'Sold on DEX',
    saldoLiquido: 'Net',
    ...
    tipoMovQueima: 'Burn',
    tipoEnvioProjeto: 'Transfer from project',
    tipoRecebeProjeto: 'Transfer to project',
    movCompraDex: '{a} bought tokens on {local}',
    movVendaDex: '{a} sold tokens on {local}',
    movTrocaDex: '{a} swapped on {local}; we could not tell if it was a buy or a sell',
    movSaque: '{a} withdrew tokens from {local} to their own wallet',
    movDeposito: '{a} deposited tokens into {local}',
    movQueima: '{a} sent tokens to a burn address (they were destroyed)',
    movEnvioProjeto: 'Project wallet {a} sent tokens to {b}',
    movRecebeProjeto: '{a} sent tokens to project wallet {b}',
    movTransferencia: '{a} sent tokens to {b}',
    localPoolDesconhecida: 'an unidentified trading pool',
    raioCorretorasTitulo: 'Identified exchanges (not a buy or a sell)',
    raioCorretorasTexto: (saq, nSaq, dep, nDep) => `Withdrawals: ${saq} (${nSaq}) — tokens leaving the exchange to personal wallets. Deposits: ${dep} (${nDep}) — tokens entering the exchange, which usually comes before a sale there.`,
    ...
    raioSub: 'The same buys and sells as the balance (DEX pools only), split by the type of wallet that traded.',
    raioCategoria: 'Who',
    raioSaldo: 'Net',
